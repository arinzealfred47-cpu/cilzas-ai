...
// ISO 639-1 language codes — the standard set used by most language pickers
// (Google, Netflix, etc). Sorted alphabetically by English name below.
const RAW_LANGUAGES: Language[] = [
  ...
  { code: "sd", name: "Sindhi", nativeName: "सिन्धी", rtl: true },
  ...
  { code: "ug", name: "Uighur", nativeName: "ئۇيغۇرچە", rtl: true },
  ...
  { code: "za", name: "Zhuang", nativeName: "Saʉ cueŋƒ" },
